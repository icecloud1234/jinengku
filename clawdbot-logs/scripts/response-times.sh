...
journalctl --user -u openclaw-gateway.service --no-pager --since "2 hours ago" 2>/dev/null | \
...
echo ""
echo "=== Summary ==="
journalctl --user -u openclaw-gateway.service --no-pager --since "1 hour ago" 2>/dev/null | \
